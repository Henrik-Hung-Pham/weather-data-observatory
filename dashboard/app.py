...
def render_overview(db: DatabaseManager):
...
def render_weather_data(db: DatabaseManager):
    ...
    st.dataframe(
        filtered_df[['city', 'country', 'temperature_celsius', 'humidity', 
                     'weather_condition', 'wind_speed', 'recorded_at']].sort_values(
...
def render_quality_metrics(db: DatabaseManager):
    ...
    rules_df = pd.DataFrame([
        {"Rule": "Schema Drift Detection", "Layer": "All", "Severity": "🔴 Critical", "Status": "Active"},
        {"Rule": "Null Value Check", "Layer": "All", "Severity": "🟡 Warning", "Status": "Active"},
        {"Rule": "Temperature Range", "Layer": "Silver/Gold", "Severity": "🟡 Warning", "Status": "Active"},
        {"Rule": "Humidity Range", "Layer": "Silver/Gold", "Severity": "🟡 Warning", "Status": "Active"},
        {"Rule": "Data Freshness", "Layer": "Gold", "Severity": "🟡 Warning", "Status": "Active"},
        {"Rule": "Uniqueness Check", "Layer": "Gold", "Severity": "🔴 Critical", "Status": "Active"},
    ])
